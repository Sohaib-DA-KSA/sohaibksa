        ...
        <AnimatedSection>
          <div className="text-center space-y-3">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 text-primary text-xs font-semibold">
              ...
              Currently available for Data Analyst roles
            </div>
          </div>
        </AnimatedSection>
          ...
          <AnimatedSection direction="right" delay={0.15}>
            <div className="glass-panel rounded-2xl p-6 h-full">
              ...
              <form ref={formRef} className="space-y-4" onSubmit={handleSubmit}>
                <Input name="from_name" placeholder="Your Name" className="bg-muted/30 border-border" required />
                <Input type="email" name="from_email" placeholder="Your Email" className="bg-muted/30 border-border" required />
                <Textarea name="message" placeholder="Your Message" rows={4} className="bg-muted/30 border-border" required />
